module github.com/HELL0ANTHONY/payment-system/lambdas/payment-orchestrator

go 1.25.5

require (
	github.com/HELL0ANTHONY/payment-system/shared v0.0.0
...
replace github.com/HELL0ANTHONY/payment-system/shared => ../../shared
